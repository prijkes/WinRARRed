...
namespace RARLib
{
    ...
    public class RAR5HeaderReader
    {
        ...
        private RAR5ServiceBlockInfo? ParseServiceBlock(RAR5BlockReadResult block, long headerEnd)
        {
            ...
            // Bits 0-5: compression version, Bits 6: solid, Bits 7-10: method (0-5), Bits 11-14: min dict size
            ...
            // Method 0 means stored (no compression)
