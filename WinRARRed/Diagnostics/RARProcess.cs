...
public sealed partial class RARProcess
{
    ...
    public async Task<int> RunAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            Log.Debug(this, $"Starting RAR process: {ProcessFilePath}", LogTarget);
            Log.Debug(this, $"Working Directory: {InputDirectory}", LogTarget);
            Log.Debug(this, $"Output File: {OutputFilePath}", LogTarget);
            Log.Debug(this, $"Arguments: {string.Join(" ", CommandLineOptions)}", LogTarget);
            ...
            Log.Information(this, $"RAR process completed. Exit Code: {exitCode}, Duration: {elapsed.TotalSeconds:F2}s, Output: {OutputFilePath}", LogTarget);
        ...
        {
            Log.Warning(this, $"RAR process cancelled: {OutputFilePath}", LogTarget);
        ...
        {
            Log.Error(this, ex, $"RAR process failed: {OutputFilePath}", LogTarget);
